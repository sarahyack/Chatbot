...
class TestPreprocessing(unittest.TestCase):
    ...
    def test_return_title_and_year(self, mock_splitext: MagicMock, mock_gmtime: MagicMock, mock_getmtime: MagicMock) -> None:
    ...
    def test_read_file_content(self, mock_docx: MagicMock, mock_load: MagicMock, mock_join: MagicMock, mock_listdir: MagicMock, mock_return_title_and_year: MagicMock) -> None:
    ...
    def test_main(self, mock_close_db: MagicMock, mock_exists: MagicMock, mock_create_db: MagicMock, mock_open_db: MagicMock, mock_setup_lemmatizer: MagicMock, mock_read_file_content: MagicMock, mock_process_content: MagicMock, mock_insert_into_database: MagicMock) -> None:
        # Arrange
        ...
        mock_insert_into_database.assert_called_with([('test file', 2020, 'processed content')], mock_conn, mock_cursor, 'essays', print_output = True)
